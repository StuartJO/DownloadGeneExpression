...
```
python ./ViewGeneExpression.py lh.white lh.geneID_793.gii --parc lh.Schaefer_1000_7Net.annot --parc_rescale 1
```

<img src="./example_plots/Smoothed_rescaled.png" width="100%">
